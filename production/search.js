 ...
 * @returns {Number}
 */
exports.linearSearch = function (array, item) {
 ...
 * @returns {Number}
 */
exports.binarySearchFirstEntry = function (array, item) {
    var left = 0;
 ...
 * @returns {Number}
 */
exports.binarySearchLeftBorder = function(array, item) {
    var left = 0;
    var right = array.length - 1;
    while (left < right) {
        var middle = Math.floor((right + left) / 2);
 ...
 * @returns {Number}
 */
exports.binarySearchLastEntry = function(array, item) {
    var left = -1;
 ...
 * @returns {Number}
 */
exports.binarySearchRightBorder = function(array, item) {
    var left = 0;
    var right = array.length - 1;
    while (left < right) {
        var middle = Math.floor((right + left) / 2);
